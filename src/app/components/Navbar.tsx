    ...
    <motion.nav initial={{ y: -100 }} animate={{ y: 0 }} className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      <div className="flex items-center gap-4 rounded-full border border-[#333] bg-[#111111] px-4 py-3 text-[#FFFBF5] shadow-lg md:gap-8 md:px-6">
        ...
        <div className="hidden items-center gap-6 text-sm font-medium md:flex">
          <a href="#projects" className="transition-colors hover:text-[#FF5C28]">
            {copy.projects}
          </a>
          <a href="#capabilities" className="transition-colors hover:text-[#FF5C28]">
            {copy.capabilities}
          </a>
          <a href="#about" className="transition-colors hover:text-[#FF5C28]">
            {copy.about}
          </a>
          <a href="#faq" className="transition-colors hover:text-[#FF5C28]">
            {copy.faq}
          </a>
        </div>
        ...
        <a href="#contact" className="rounded-full bg-[#B2FF59] px-4 py-1.5 text-sm font-bold text-black transition-transform hover:scale-105">
          {copy.contact}
        </a>
      </div>
    </motion.nav>
